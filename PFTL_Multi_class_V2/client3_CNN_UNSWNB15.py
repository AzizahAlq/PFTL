...
# ============================================================
# PTFL Client3 (UNSW-NB15) (Design-B + STRICT BARRIER) - CLIENT1 STYLE
# ============================================================
# Fixed rules (same as your Client1 strict version):
...
# 6) Logs include SEED and CURVE_CSV stores ONLY macro-f1 (local vs global), same v2 style
# 7) SAME split rule: TEST=0.15, VAL_FROM_TRAIN=0.15/(1-0.15)
# ============================================================
...
CLIENT_ID      = os.environ.get("CLIENT_ID", "client3")
...
CSV_PATH  = os.environ.get(
    "CSV_PATH",
    "/Users/azizahalq/Desktop/PFTL_Multi_class/M_PFTL_codes/Multi_class_Datasets/D3_UNSW_NB15_ALL_MERGED_final.csv"
)
LABEL_COL = os.environ.get("LABEL_COL", "attack_cat")

OUT_DIR = os.environ.get(
    "OUT_DIR",
    "/Users/azizahalq/Desktop/PFTL_Multi_class/ptfl_logs/client3_unsw_v2"
)
...
# ============================================================
# Model (MATCH your Client3 standalone architecture)
# ============================================================
def build_cnn(input_shape, num_classes):
    ...
    # UNSW is multi-class in your setup
...
# Client
# ============================================================
class PTFLClient3DesignB_StrictBarrier:
    def __init__(self):
        ensure_csv_headers()
    ...
    def _load_data(self):
        ...
        # IMPORTANT: match your "critical infinity fix"
        ...
        # drop id/label like your standalone, keep numeric only
        X_df = df.drop(columns=[LABEL_COL, "id", "label"], errors="ignore").select_dtypes(include=[np.number]).copy()
...
if __name__ == "__main__":
    PTFLClient3DesignB_StrictBarrier().run()
