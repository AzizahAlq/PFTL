...
# ============================================================
# client5_BCCC_NRC_2024_PTFL_DESIGN_B_LOCAL_FIRST_STRICT_BARRIER.py
...
CSV_PATH  = os.environ.get(
    "CSV_PATH",
    "/Users/azizahalq/Desktop/PFTL_Multi_class/M_PFTL_codes/Multi_class_Datasets/D5_CIC-BCCC-NRC_2024_Balanced_Final.csv"
)
LABEL_COL = os.environ.get("LABEL_COL", "Label")

OUT_DIR = os.environ.get(
    "OUT_DIR",
    f"/Users/azizahalq/Desktop/M_PFTL_codes/ptfl_logs/{CLIENT_ID}_v2_localfirst_strict"
)
...
class PTFLClient5_LocalFirst_StrictBarrier:
    def __init__(self):
        ensure_csv_headers()
    ...
    def _load_data(self):
        ...
        print("\n=== Client5 PTFL Readiness Summary ===")
...
if __name__ == "__main__":
    ensure_csv_headers()
    PTFLClient5_LocalFirst_StrictBarrier().run()
