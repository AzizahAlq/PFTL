...
CSV_PATH  = os.environ.get(
    "CSV_PATH",
    "/nfs/aalqahtani/PFTL_Multi_class/M_PFTL_codes/Multi_class_Datasets/D4_Merged_ALL_CIC_IDS_2017_TOTAL_200K.csv"
)
LABEL_COL = os.environ.get("LABEL_COL", "Label")

OUT_DIR = os.environ.get(
    "OUT_DIR",
    f"/nfs/aalqahtani/PFTL_Multi_class/ptfl_logs/{CLIENT_ID}_v2_localfirst_strict"
)
