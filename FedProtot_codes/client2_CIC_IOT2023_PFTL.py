...
CSV_PATH  = os.environ.get(
    "CSV_PATH",
    "/nfs/aalqahtani/PFTL_Multi_class/M_PFTL_codes/Multi_class_Datasets/D2_cic_iot_2023_200k_keep_selected_new.csv"
)
LABEL_COL = os.environ.get("LABEL_COL", "Label")

OUT_DIR = os.environ.get(
    "OUT_DIR",
    f"/nfs/aalqahtani/PFTL_Multi_class/M_PFTL_codes/ptfl_logs/{CLIENT_ID}_v2_localfirst_strict"
)
