...
CSV_PATH  = os.environ.get(
    "CSV_PATH",
    "/nfs/aalqahtani/PFTL_Multi_class/M_PFTL_codes/Multi_class_Datasets/D3_UNSW_NB15_ALL_MERGED_final.csv"
)
LABEL_COL = os.environ.get("LABEL_COL", "attack_cat")

OUT_DIR = os.environ.get(
    "OUT_DIR",
    "/nfs/aalqahtani/PFTL_Multi_class/ptfl_logs/client3_unsw_v2"
)
