...
"""
Client 6 label inspection and FedProto mapping
...
5. Maps the 15 classes to standardized semantic labels.
...
ORIGINAL_DISTRIBUTION_CSV = (
    DATA_DIR
    / "D6_CIC-IoT-IDAD-2024_original_label_distribution.csv"
)

MAPPED_DISTRIBUTION_CSV = (
    DATA_DIR
    / "D6_CIC-IoT-IDAD-2024_mapped_label_distribution.csv"
)
...
REMOVED_ROWS_CSV = (
    DATA_DIR
    / "D6_CIC-IoT-IDAD-2024_removed_missing_label_rows.csv"
)


# ============================================================
# Fixed local class order for Client 6
# ============================================================
CANONICAL_CLASSES = [
...
LABEL_ALIASES = {
    ...
    "ddos ackfragmentation": "DDOS_ACK_FRAGMENTATION",

    # DoS HTTP flood
    "dos http flood": "DOS_HTTP_FLOOD",
    "dos httpflood": "DOS_HTTP_FLOOD",

    # DDoS HTTP flood
    "ddos http flood": "DDOS_HTTP_FLOOD",
    "ddos httpflood": "DDOS_HTTP_FLOOD",
    ...
    "ddos icmpfragmentation": "DDOS_ICMP_FRAGMENTATION",
...
def main() -> None:
    ...
    print_separator("CLIENT 6 LOCAL LABEL MAPPING")
    ...
    print("\nClient 6 mapping completed successfully.")
